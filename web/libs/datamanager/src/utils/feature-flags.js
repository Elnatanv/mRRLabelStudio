 ...
 */
export const FF_LSDV_4620_3_ML =
...
export const FF_MEMORY_LEAK_FIX =
 ...
 */
export const FF_REGION_VISIBILITY_FROM_URL =
 ...
 */
export const FF_AVERAGE_AGREEMENT_SCORE_POPOVER =
 ...
 */
export const FF_ANNOTATION_RESULTS_FILTERING =
...
export function isFF(id) {
  ...
  if (
    window?.APP_SETTINGS?.sentry_environment === "opensource" &&
    id in override
  ) {
    return override[id];
  }
